  ...
  const categories = [
    ...
    },
    {
      ...
      phrases: [
        ...
        { text: 'ต้องการปรับท่านอน', image: BlueB },
        { text: 'ต้องการพบแพทย์', image: BlueC },
        { text: 'ต้องการพบญาติ', image: BlueD },
        { text: 'หิว', image: BlueE },
        { text: 'ต้องการพลิกตัว', image: BlueF },
        { text: 'ต้องการดูดเสมหะ', image: BlueG },
        { text: 'ปัสสาวะ', image: BlueH },
        { text: 'ถ่ายอุจจาระ', image: BlueI },
        { text: 'ต้องการอาบน้ำ', image: BlueJ },
